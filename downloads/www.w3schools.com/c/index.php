...
<div class="tut_overview">
<a target="_top" href="c_conditions.php">C If...Else</a>
<a target="_top" href="c_conditions_short_hand.php">C Short Hand If</a>
</div>
...
<a target="_top" href="c_pointers.php">C Pointers</a>
<br>
...
<a target="_top" href="c_examples.php">C Examples</a>
<a target="_top" href="c_exercises.php">C Exercises</a>
<a target="_top" href="c_quiz.php">C Quiz</a>
<a target="_top" href="c_compiler.php">C Compiler</a>
      <br><br>
    </div>
  </div>
</div>
...
<h2>Learn C</h2>
<p>C is a general-purpose programming language, developed in 1972, and still 
quite popular.</p>
...
<p>Our Try it Yourself tool makes it easy to learn C. You can edit code and view 
...
int <input name="ex1" maxlength="4" style="width: 45px;">() {
  <input name="ex2" maxlength="6" style="width: 65px;">("Hello World!");
  return 0;
}
</pre>
</div>
...
<a class="w3-right w3-btn w3-round" href="c_intro.php" style="font-family: 'Roboto Mono', monospace;background-color:#04AA6D;padding:20px;text-align:right"><span style="color:#D9EEE1">Next &#10095;</span><br class="w3-hide-small"><span class="w3-hide-small"> C Introduction</span></a>
</div>
