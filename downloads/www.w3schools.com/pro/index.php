...
<html lang="en-US">
<head>
<title>Become a PRO User at W3schools</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="Keywords" content="PRO User. Support. Subscribe. Unlock powerful features. Get access. Ad free. Browse without ads.">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/w3schools_logo_436_2.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="436">
<meta property="og:image:height" content="228">
<meta property="og:title" content="Become a PRO User">
<meta property="og:description" content="Become a PRO User at W3Schools and unlock powerful features">
...
<link rel="stylesheet" href="/videos/files/videojs/video-js.css">
<link rel="stylesheet" href="/videos/files/videojs/videojs-quality-menu.css">
...
@media screen and (max-width:620px) {
  .caption {padding: 70px 15px 70px 15px;}
  .caption h1 {font-size:50px;}
  .caption h3 {font-size:24px;}
  .caption li {font-size:18px;}
  .footerpro {
...
#whatsincluded{
  background: url("coffee2.jpg") no-repeat fixed center;
}
...
#spacesintro {
  background:url("priscilla-du-preez-XkKCui44iM0-unsplash.921aa0c0.jpg") no-repeat fixed center;
}
...
<nav id="nav_tutorials" class="w3-hide-small navex" style="position:absolute;background-color:#282A35;color:white;padding-bottom:60px;">
 ...
 <div class="w3-col l3 m6">
   ...
   <a class="w3-bar-item w3-button" href="/pro/index_pror_br.asp">Where To Start</a>
...
<div class="caption">
  ...
  <h3>Unlock powerful features:</h3>
  ...
  <p><a title="read more" style="margin-top:15px;margin-bottom:15px;padding-left:40px;padding-right:40px;font-size:19px;border-radius:25px;font-weight:600;font-family: Source Sans Pro,sans-serif;" class="ws-btn" title="Go Pro" id="plans_pro_btn" href="https://billing.w3schools.com/products/spaces?frequency=monthly&amp;selectedPlan=pro-monthly" onclick="ga('send', 'event', 'spacesFromLanding', 'LinkPlansPro')">Subscribe for $4.99 <span style="opacity:0.9">/month</span></a></p>
  <!--<p style="margin-top:15px;font-size:18px">Cancel anytime</p>-->
</div>

<div class="anim" style="text-align:center;margin-bottom:50px;margin-top:-50px;">
  <a class="fa fa-arrow-down fa-2x" href="#whatsincluded" style="text-decoration:none"></a>
</div>

<div id="whatsincluded" class="w3-white w3-center" style="padding:80px 30px 100px 30px;color:black;font-family: 'Source Sans Pro', sans-serif;">
  <h2 style="font-size:50px;font-weight:700;margin-bottom:25px;" class="textsmallerscreens">Remove ads</h2>
  <h3 style='font-size:24px;'>PRO Users browse W3Schools.com without ads.</h3>
</div>

<div id="spacesintro" class="w3-center" style="background-color:#232434;color:white;">
  <div style="background-color:#282A35;opacity:0.95;margin:auto;padding:70px 20px;">
...
<div class="ws-yellow w3-center" style="padding:25px 25px 75px 25px;xmargin-top:50px;bxorder-radius:5px;">
  <h3 style="margin-bottom:50px;margin-top:50px;font-size:30px">PRO Users get</h3>
  <div class="w3-row-padding w3-hide-small w3-hide-medium" style="font-size:20px">
    <div class="w3-col m3">
      <img src="/spaces/files/check-dark.86e19693.svg" style="margin-top:5px;margin-right:5px;background-color:#282A35!important;border-radius:50%;padding:2px;margin-bottom:2px;"> 10 spaces
    </div>
    <div class="w3-col m3">
      <img src="/spaces/files/check-dark.86e19693.svg" style="margin-top:5px;margin-right:5px;background-color:#282A35!important;border-radius:50%;padding:2px;margin-bottom:2px;"> 15 GB data / month
    </div>
    <div class="w3-col m3">
      <img src="/spaces/files/check-dark.86e19693.svg" style="margin-top:5px;margin-right:5px;background-color:#282A35!important;border-radius:50%;padding:2px;margin-bottom:2px;"> 200 000 requests / month
    </div>
    <div class="w3-col m3">
      <img src="/spaces/files/check-dark.86e19693.svg" style="margin-top:5px;margin-right:5px;background-color:#282A35!important;border-radius:50%;padding:2px;margin-bottom:2px;"> 3GB storage
    </div>
  </div>
  
  <div style="text-align:center;margin:auto" class="w3-hide-large">
    <ul style="display:inline-block">
      <li style="font-size:20px;line-height:36px;text-align:left;list-style-type:none;"><img src="/spaces/files/check-dark.86e19693.svg" style="margin-right:15px;background-color:#282A35!important;border-radius:50%;padding:2px;margin-bottom:2px;"> 10 spaces</li>
      <li style="font-size:20px;line-height:36px;text-align:left;list-style-type:none;"><img src="/spaces/files/check-dark.86e19693.svg" style="margin-right:15px;background-color:#282A35!important;border-radius:50%;padding:2px;margin-bottom:2px;"> 15 GB data / month</li>
      <li style="font-size:20px;line-height:36px;text-align:left;list-style-type:none;"><img src="/spaces/files/check-dark.86e19693.svg" style="margin-right:15px;background-color:#282A35!important;border-radius:50%;padding:2px;margin-bottom:2px;"> 200 000 requests / month</li>
      <li style="font-size:20px;line-height:36px;text-align:left;list-style-type:none;"> <img src="/spaces/files/check-dark.86e19693.svg" style="margin-right:15px;background-color:#282A35!important;border-radius:50%;padding:2px;margin-bottom:2px;"> 3GB storage</li>
    </ul>
  </div>
</div>
...
<div class="w3-center ws-black" style="padding:80px 30px 15px 30px;color:black;font-family: 'Source Sans Pro', sans-serif;">
  <h2 style="font-size:50px;font-weight:700;margin-bottom:25px;" class="textsmallerscreens">HTML Video Tutorial</h2>
  <h3 style='margin-bottom:45px;font-size:24px;font-wexight:400!important;'>PRO Users get
  <strong>full access</strong> to our popular HTML Video tutorial.<br></h3>
  <p style="font-size:18px">Click the play button for a sneak peek:</p>
  
  <div id="thevideo">
    <video id="my-video" class="video-js vjs-big-play-centered vjs-16-9" controls preload="auto" poster="/videos/img_intro2.png" data-setup='{ "techOrder": ["youtube"], "sources": [{ "type": "video/youtube", "src": "https://youtu.be/ewZ_YWbIWXI"}] }' responsive="true">
      <track kind="captions" src="/videos/files/subs/01_w3schools_html_intro.vtt" srclang="en" label="English">
      <p class="vjs-no-js">
...
<div class="w3-center footerpro">      
  <p><a style="margin-top:15px;padding-top:8px;padding-bottom:8px;margin-bottom:15px;padding-left:40px;padding-right:40px;font-size:19px;border-radius:25px;font-weight:600;font-family: Source Sans Pro,sans-serif;" class="ws-btn" title="Go Pro" id="plans_pro_btn" href="https://billing.w3schools.com/products/spaces?frequency=monthly&amp;selectedPlan=pro-monthly" onclick="ga('send', 'event', 'spacesFromLanding', 'LinkPlansPro')">Subscribe for $4.99 <span style="opacity:0.9">/month</span></a></p>
  <p style="font-size:18px">Cancel anytime.</p>
</div> 
...
<script src="/videos/files/videojs/video.min.js"></script>
<script src="/videos/files/videojs/youtube.js"></script>
