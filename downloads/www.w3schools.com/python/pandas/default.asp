...
<a target="_top" href="pandas_quiz.asp">Pandas Quiz</a>
<a target="_top" href="pandas_exercises.asp">Pandas Exercises</a>
<a target="_top" href="pandas_exam.asp">Pandas Certificate</a>
<br>
<h2 class="left">References</h2>
<a target="_top" href="pandas_ref_dataframe.asp">DataFrames Reference</a>
<br>
...
<form autocomplete="off" id="w3-exerciseform" action="exercise.asp?filename=exercise_series1" method="post" target="_blank">
<h2>Pandas Exercises</h2>
<div class="exercisewindow">
<h2>Exercise:</h2>
<p>Insert the correct Pandas method to create a Series.</p>
...
<p><a target="_blank" href="exercise.asp?filename=exercise_series1">Start the Exercise</a></p>
</div>
</form>
...
<a href="https://shop.w3schools.com/collections/course-catalog" target="_blank" onclick="ga('send', 'event', 'Courses' , 'Clicked on certified badge');">
...
Get Certified!</h2>
<div>Complete the Pandas modules, do the exercises, take the exam, and you will become w3schools certified!</div>
<br>
<a class="w3-btn" id="buy_course_btn" 
href="https://shop.w3schools.com/collections/course-catalog/products/pandas-course" target="_blank" onclick="ga('send', 'event', 'Pandas Course' , 'Clicked on $10 ENROLL');">$10 ENROLL</a>
</div>
