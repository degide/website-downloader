...
<hr><p class="intro">You can test your Pandas skills with W3Schools' Exercises.</p>
<hr><h2>Exercises</h2>
<p>We have gathered a variety of Pandas exercises (with answers) for each Pandas Chapter.</p>
...
<div class="ws-black w3-padding w3-margin-top w3-round">
  <h2>Start Pandas Exercises</h2>
  <p>Good luck!</p>
  <p><a href="exercise.asp" target="_blank" class="ws-btn" style="margin-top:10px;padding:15px 25px;font-size:18px">Start Pandas Exercises &#10095;</a></p>
</div>
