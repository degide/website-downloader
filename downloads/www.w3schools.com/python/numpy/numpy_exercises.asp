...
<a target="_top" href="numpy_quiz.asp">NumPy Quiz</a>
<a target="_top" href="numpy_exercises.asp">NumPy Exercises</a>
<a target="_top" href="numpy_exam.asp">NumPy Certificate</a>
...
<hr><p class="intro">You can test your NumPy skills with W3Schools' Exercises.</p>
<hr><h2>Exercises</h2>
<p>We have gathered a variety of NumPy exercises (with answers) from the NumPy Chapters.</p>
...
<div class="ws-black w3-padding w3-margin-top w3-round">
  <h2>Start NumPy Exercises</h2>
  <p>Good luck!</p>
  <p><a href="exercise.asp" target="_blank" class="ws-btn" style="margin-top:10px;padding:15px 25px;font-size:18px">Start NumPy Exercises &#10095;</a></p>
</div>
