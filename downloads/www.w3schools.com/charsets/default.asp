...
<p>The HTML5 specification encourages web developers to use the UTF-8 character 
set!</p>
...
considered as the standard character set.</p>
...
<p>The character set most often used in HTML 4 was ISO-8859-1.</p>
