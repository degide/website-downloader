...
<h1>MySQL <span class="color_h1">Exercises</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="mysql_quiz.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="default.asp">Next &#10095;</a>
</div>
<hr><p class="intro">You can test your MySQL skills with W3Schools' Exercises.</p>
<hr><h2>Exercises</h2>
<p>We have gathered a variety of MySQL exercises (with answers) for each MySQL Chapter.</p>
...
<div class="ws-black w3-padding w3-margin-top w3-round">
  <h2>Start MySQL Exercises</h2>
  <p>Good luck!</p>
  <p><a href="exercise.asp" target="_blank" class="ws-btn" style="margin-top:10px;padding:15px 25px;font-size:18px">Start MySQL Exercises &#10095;</a></p>
</div>
<div class="w3-note w3-panel">
  <p>If you don't know MySQL, we suggest that you read our <a href="default.asp">MySQL Tutorial</a> from scratch.</p>
</div>
