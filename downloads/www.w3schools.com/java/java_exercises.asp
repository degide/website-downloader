...
<hr>
<p class="intro">You can test your Java skills with W3Schools' Exercises.</p>

<hr>
<h2>Exercises</h2>
<p>We have gathered a variety of Java exercises (with answers) for each Java Chapter.</p>
...
<div class="ws-black w3-padding w3-margin-top w3-round">
  <h2>Start Java Exercises</h2>
  <p>Good luck!</p>
  <p><a href="exercise.asp?filename=exercise_syntax1" target="_blank" class="ws-btn" style="margin-top:10px;padding:15px 25px;font-size:18px">Start Java Exercises &#10095;</a></p>
</div>
