...
<script src='/lib/prism2.js'></script><link rel='stylesheet' href='/lib/prism1.css'><script>
...
body.darkpagetheme .topnavmain_pro {
  ...
  <a class="w3-bar-item w3-button w3-hide-medium bar-item-hover w3-hide-small w3-padding-24 barex" href="https://www.w3schools.com/videos/index.php" title="Video Tutorials" onclick="ga('send', 'event', 'Videos' , 'fromTopnavMain')">Videos</a>
  ...
  <div class="w3-right w3-padding-16">
    ...
    <a class="w3-bar-item w3-button bar-item-hover w3-right ws-hide-900 w3-hide-small ws-hide-1066 barex topnavmain_pro" style="border-radius: 25px; margin-right: 15px;" href="/pro/index.php" target="_blank" onclick="ga('send', 'event', 'Pro', 'FromTopnavMainPHP');" title="Go pro and unlock powerful features">Pro <span class="ribbon-topnav ws-hide-1160">NEW</span></a>    
  </div>  
</div>
...
<h2 class="left"><span class="left_h2">Django</span> Tutorial</h2>
<a target="_top" href="index.php">Django Home</a>
<a target="_top" href="django_intro.php">Django Intro</a>
<a target="_top" href="django_getstarted.php">Django Get Started</a>
<a target="_top" href="django_create_project.php">Django Create Project</a>
<a target="_top" href="django_create_app.php">Django Create App</a>
<a target="_top" href="django_views.php">Django Views</a>
<a target="_top" href="django_templates.php">Django Templates</a>
<a target="_top" href="django_models.php">Django Models</a>
<a target="_top" href="django_add_members.php">Django Add Members</a>
<a target="_top" href="django_add_template.php">Django Add Template</a>
<a target="_top" href="django_add_record.php">Django Add Record</a>
<a target="_top" href="django_delete_record.php">Django Delete Record</a>
<a target="_top" href="django_update_record.php">Django Update Record</a>
<br>
<h2 class="left">Django Templates</h2>
<a target="_top" href="django_template_variables.php">Django Variables</a>
<a target="_top" href="django_template_tags.php">Django Tags</a>
<a target="_top" href="django_tags_if.php">Django If Else</a>
<a target="_top" href="django_tags_for.php">Django For Loop</a>
<a target="_top" href="django_tags_comment.php">Django Comment</a>
<a target="_top" href="django_tags_cycle.php">Django Cycle</a>
<a target="_top" href="django_tags_extends.php">Django Extends</a>
<a target="_top" href="django_tags_include.php">Django Include</a>
<a target="_top" href="django_tags_filter.php">Django Filter</a>
<br>
<h2 class="left">Django QuerySets</h2>
<a target="_top" href="django_queryset.php">QuerySet Introduction</a>
<a target="_top" href="django_queryset_get.php">QuerySet Get</a>
<a target="_top" href="django_queryset_filter.php">QuerySet Filter</a>
<a target="_top" href="django_queryset_orderby.php">QuerySet Order By</a>
<br>
<h2 class="left">Django References</h2>
<a target="_top" href="django_ref_template_tags.php">Template Tag Reference</a>
<a target="_top" href="django_ref_filter.php">Filter Reference</a>
<a target="_top" href="django_ref_field_lookups.php">Field lookups Reference</a>
<br>
<!--
<h2 class="left">Django Exercises</h2>
<a target="_top" href="django_quiz.php">Django Quiz</a>
<a target="_top" href="django_exercises.php">Django Exercises</a>
-->      <br><br>
    </div>
  </div>
</div>
  ...
  <div class='w3-row w3-white'>
    <div class='w3-col l10 m12' id='main'>
      <div id='mainLeaderboard' style='overflow:hidden;'>
        ...
        <!-- adspace leaderboard -->
      </div><h1>Django Tutorial</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="/default.asp">&#10094; Home</a>
<a class="w3-right w3-btn" href="django_intro.php">Next &#10095;</a>
</div>

<div class="w3-panel w3-info intro w3-pale-red">
  ...
  <a class="w3-btn w3-margin-bottom startlearningbtn" href="django_intro.php">Start learning 
  Django now &#10095;</a>
</div>
...
You will learn how to create a model where you can create, read, update or delete data.</p>

<p>
You will learn how to make HTML Templates and use Django Template Tags to insert data within a HTML document.</p>
...
<h3 style="text-align:center">Django Project</h3>
<a href="django_intro.php" class="w3-btn pelle-btn">Introduction</a>
<div class="pelle-divider">&nbsp;</div>
<a href="django_getstarted.php" class="w3-btn pelle-btn">Getting Started</a><br>
<div class="pelle-divider">&nbsp;</div>
<a href="django_create_project.php" class="w3-btn pelle-btn">Create Project</a><br>
<div class="pelle-divider">&nbsp;</div>
<a href="django_create_app.php" class="w3-btn pelle-btn">Create App</a><br>
<div class="pelle-divider">&nbsp;</div>
<a href="django_views.php" class="w3-btn pelle-btn">Views</a><br>
<div class="pelle-divider">&nbsp;</div>
<a href="django_templates.php" class="w3-btn pelle-btn">Templates</a><br>
<div class="pelle-divider">&nbsp;</div>
<a href="django_models.php" class="w3-btn pelle-btn">Models</a><br>
<div class="pelle-divider">&nbsp;</div>
<a href="django_add_members.php" class="w3-btn pelle-btn">Add Members</a><br>
<div class="pelle-divider">&nbsp;</div>
<a href="django_add_template.php" class="w3-btn pelle-btn">Add Template</a><br>
<div class="pelle-divider">&nbsp;</div>
<a href="django_add_record.php" class="w3-btn pelle-btn">Add Record</a><br>
<div class="pelle-divider">&nbsp;</div>
<a href="django_delete_record.php" class="w3-btn pelle-btn">Delete Record</a><br>
<div class="pelle-divider">&nbsp;</div>
<a href="django_update_record.php" class="w3-btn pelle-btn">Update Record</a><br>
</div>
<div class="w3-col m4 l4">
<h3>Templates</h3>
<a href="django_template_variables.php" class="w3-btn pelle-btn x2">Variables</a><br>
<div class="pelle-divider x2">&nbsp;</div>
<a href="django_template_tags.php" class="w3-btn pelle-btn x2">Template Tags</a><br>
<div class="pelle-divider x2">&nbsp;</div>
<a href="django_tags_if.php" class="w3-btn pelle-btn x2">If...Else</a><br>
<div class="pelle-divider x2">&nbsp;</div>
<a href="django_tags_for.php" class="w3-btn pelle-btn x2">For Loop</a><br>
<div class="pelle-divider x2">&nbsp;</div>
<a href="django_tags_comment.php" class="w3-btn pelle-btn x2">Comment</a><br>
<div class="pelle-divider x2">&nbsp;</div>
<a href="django_tags_cycle.php" class="w3-btn pelle-btn x2">Cycle</a><br>
<div class="pelle-divider x2">&nbsp;</div>
<a href="django_tags_extends.php" class="w3-btn pelle-btn x2">Extends</a><br>
<div class="pelle-divider x2">&nbsp;</div>
<a href="django_tags_include.php" class="w3-btn pelle-btn x2">Include</a><br>
<div class="pelle-divider x2">&nbsp;</div>
<a href="django_tags_filter.php" class="w3-btn pelle-btn x2">Filter</a><br>
</div>
<div class="w3-col m4 l4">
<h3>QuerySets</h3>
<a href="django_queryset.php" class="w3-btn pelle-btn x3">QuerySet</a><br>
<div class="pelle-divider x3">&nbsp;</div>
<a href="django_queryset_get.php" class="w3-btn pelle-btn x3">Get Data</a><br>
<div class="pelle-divider x3">&nbsp;</div>
<a href="django_queryset_filter.php" class="w3-btn pelle-btn x3">Filter</a><br>
<div class="pelle-divider x3">&nbsp;</div>
<a href="django_queryset_orderby.php" class="w3-btn pelle-btn x3">Order By</a><br>
</div>
</div>
</div>
...
<div class="w3-code notranslate htmlHigh">
  &lt;ul&gt;<br>&nbsp; {% for x in mymembers %}<br>&nbsp;&nbsp;&nbsp; &lt;li&gt;{{ 
  x.firstname }}&lt;/li&gt;<br>&nbsp; {% endfor %}<br>&lt;/ul&gt; </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showdjango.php?filename=demo_django_index">Run Example &raquo;</a>
</div>
<hr>
<h2>Learning by References</h2>

<p>You will also find references over the most common Django features:</p>

<div class="refcont">
  <a class="bigbtn ws-grey ws-hover-black" href="django_ref_template_tags.php">Template Tags</a>
  <a class="bigbtn ws-grey ws-hover-black" href="django_ref_filter.php">QuerySet Filters</a>
  <a class="bigbtn ws-grey ws-hover-black" href="django_ref_field_lookups.php">Field Lookups</a>
</div>
