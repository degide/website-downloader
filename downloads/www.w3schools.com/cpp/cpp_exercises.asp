...
<hr><p class="intro">You can test your C++ skills with W3Schools' Exercises.</p>
<hr><h2>Exercises</h2>
...
<div class="ws-black w3-padding w3-margin-top w3-round">
  ...
  <p>Good luck!</p>
  <p><a href="exercise.asp?filename=exercise_syntax1" target="_blank" class="ws-btn" style="margin-top:10px;padding:15px 25px;font-size:18px">Start C++ Exercises &#10095;</a></p>
</div>
